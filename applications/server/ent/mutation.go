...
func (m *TagMutation) AddTransactionIDs(ids ...string) {
...
func (m *TagMutation) RemoveTransactionIDs(ids ...string) {
...
func (m *TagMutation) RemovedTransactionsIDs() (ids []string) {
...
func (m *TagMutation) TransactionsIDs() (ids []string) {
...
func (m *TransactionMutation) AddTagIDs(ids ...string) {
	if m.tags == nil {
...
func (m *TransactionMutation) RemoveTagIDs(ids ...string) {
...
func (m *TransactionMutation) RemovedTagsIDs() (ids []string) {
...
func (m *TransactionMutation) TagsIDs() (ids []string) {
	for id := range m.tags {
		ids = append(ids, id)
	}
	return
