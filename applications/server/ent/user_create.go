...
func (uc *UserCreate) SetOtpSeed(s string) *UserCreate {
	uc.mutation.SetOtpSeed(s)
	return uc
}
...
func (uc *UserCreate) AddTagIDs(ids ...string) *UserCreate {
...
func (uc *UserCreate) createSpec() (*User, *sqlgraph.CreateSpec) {
	...
	if value, ok := uc.mutation.OtpSeed(); ok {
