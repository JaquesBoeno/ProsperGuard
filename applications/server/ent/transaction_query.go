...
func (tq *TransactionQuery) QueryHolder() *UserQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			...
			sqlgraph.Edge(sqlgraph.M2O, true, transaction.HolderTable, transaction.HolderColumn),
		)
...
func (tq *TransactionQuery) Clone() *TransactionQuery {
	...
	return &TransactionQuery{
		...
		withHolder: tq.withHolder.Clone(),
...
func (tq *TransactionQuery) WithHolder(opts ...func(*UserQuery)) *TransactionQuery {
	query := (&UserClient{config: tq.config}).Query()
...
func (tq *TransactionQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Transaction, error) {
	...
	if query := tq.withHolder; query != nil {
		if err := tq.loadHolder(ctx, query, nodes, nil,
			func(n *Transaction, e *User) { n.Edges.Holder = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (tq *TransactionQuery) loadHolder(ctx context.Context, query *UserQuery, nodes []*Transaction, init func(*Transaction), assign func(*Transaction, *User)) error {
